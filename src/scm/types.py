...
type ProviderName = Literal["bitbucket", "github", "github_enterprise", "gitlab", "perforce"]
"""The SCM provider that owns an integration or repository."""

PROVIDER_SET: set[ProviderName] = set(["bitbucket", "github", "github_enterprise", "gitlab", "perforce"])
