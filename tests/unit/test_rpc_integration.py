...
ACTION_TEST_CASES: list[tuple[str, Callable, dict | list | str, int, dict[str, str] | None]] = [
    ...
    (
        ...
        lambda scm: actions.list_repository_user_permissions(scm),
        [
            {
                "login": "reader",
                "id": 1,
    ...
    (
        ...
        lambda scm: actions.list_check_runs_in_check_suite(scm, "500"),
    ...
    (
        ...
        lambda scm: actions.list_check_suites_for_ref(scm, "abc123"),
        {"total_count": 1, "check_suites": [make_github_check_suite()]},
        200,
        None,
    ),
    (
    ...
    (
        ...
        lambda scm: actions.resolve_review_thread(scm, "1", "PRRT_abc123"),
